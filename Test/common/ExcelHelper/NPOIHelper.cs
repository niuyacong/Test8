...
namespace Jeno.App.Common.Tool
{
    public class NPOIHelper
    {
        ...
        #region 经理导出业务申报全部明细 By lijingzhou 2016/11/4
        public static MemoryStream ExportDTManager(DataTable dtSource, string IsNeedTextFoot, decimal FloatAmount)
        {
            HSSFWorkbook workbook = new HSSFWorkbook();
            HSSFSheet sheet = workbook.CreateSheet() as HSSFSheet;
            HSSFCellStyle dateStyle = workbook.CreateCellStyle() as HSSFCellStyle;
            ...
            foreach (DataRow row in dtSource.Rows)
            {
                ...
                foreach (DataColumn column in dtSource.Columns)
                {
                    ...
                    if (column.Ordinal + 1 == dtSource.Columns.Count)
                    {
                        newCell.CellFormula = "SUM(N" + (rowIndex + 1) + ":Y" + (rowIndex + 1) + ")*L" + (rowIndex + 1) + "";
                    }
            ...
            if (IsNeedTextFoot == "1")
            {
                ...
                sheet.AddMergedRegion(new Region(rowIndex, 0, rowIndex, dtSource.Columns.Count - 14));
                HSSFRow FloatAmountRow = sheet.CreateRow(rowIndex + 1) as HSSFRow;
                foreach (DataColumn column in dtSource.Columns)
                {
                    HSSFCell newCell = FloatAmountRow.CreateCell(column.Ordinal) as HSSFCell;
                    if (column.Ordinal == 0)
                    {
                        newCell.SetCellValue("业务部长浮动");                       
                    }else if (column.Ordinal == 1)
                    {
                        newCell.SetCellValue(FloatAmount.ToString());
                    }
                    else
                    {
                        newCell.SetCellValue("");
        ...
        #region 大区经理金额统计 By ljingzhou 2016/11/4
        public static MemoryStream ExportDTManagerMoney(DataTable dtSource, string IsNeedTextFoot)
        {
            HSSFWorkbook workbook = new HSSFWorkbook();
            HSSFSheet sheet = workbook.CreateSheet() as HSSFSheet;
            HSSFCellStyle dateStyle = workbook.CreateCellStyle() as HSSFCellStyle;
            ...
            if (IsNeedTextFoot == "1")
            {
                ...
                sheet.AddMergedRegion(new Region(rowIndex, 0, rowIndex, dtSource.Columns.Count - 16));
        ...
        #region 大区经理分解对比导出 By lijingzhou 2016/11/4
        public static MemoryStream ExportManagerDecompose(DataTable dtSource)
        {
            HSSFWorkbook workbook = new HSSFWorkbook();
            HSSFSheet sheet = workbook.CreateSheet() as HSSFSheet;
            HSSFCellStyle dateStyle = workbook.CreateCellStyle() as HSSFCellStyle;
        ...
        #region 部长
        public static MemoryStream ExportBranchRecord(DataTable dtSource)
        {
            HSSFWorkbook workbook = new HSSFWorkbook();
            HSSFSheet sheet = workbook.CreateSheet() as HSSFSheet;
            HSSFCellStyle dateStyle = workbook.CreateCellStyle() as HSSFCellStyle;
