...
;(function($, window, document, undefined) {
	...
	Tree.prototype = {
				...
				if (self.options.enableLinks) {
					...
					treeItem
						.append($(self._template.link)
							.attr('href', node.href)
							.append("<span class='contentText'>" + node.text + "</span>")
						);
				}
				else {
					// otherwise just text
		...
		_css: '.treeview .list-group-item{cursor:pointer}.treeview span.indent{margin-left:10px;margin-right:10px}.treeview span.expand-collapse{width:1rem;height:1rem}.treeview span.icon{margin-left:-5px;margin-right:5px;visibility: hidden;}'
